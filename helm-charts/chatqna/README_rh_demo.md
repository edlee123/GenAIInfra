...
3. Set up the Persistent Volume Claim. See the [README.md](https://github.com/edlee123/GenAIInfra/blob/redhat_demo/helm-charts/README.md?plain=1#L150)
...
```bash
cd GenAIInfra/helm-charts && chmod +x update_dependency.sh && ./update_dependency.sh  && helm dependency update chatqna
```


5. Redhat KServe endpoints in OpenShift AI (redhat-ai-services/modelcar-catalog).
